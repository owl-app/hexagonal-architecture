 ...
 */
class Owl_Apps_Api_ApiKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Owl\\Apps\\Api\\Controller\\Article\\ArticleGetController' => 'getArticleGetControllerService',
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/Owl_Apps_Api_ApiKernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Owl_Apps_Api_ApiKernelDevDebugContainer',
