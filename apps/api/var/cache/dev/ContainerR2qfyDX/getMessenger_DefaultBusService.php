 ...
 */
class getMessenger_DefaultBusService extends Owl_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['messenger.default_bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['command.bus.middleware.send_message'] ?? $container->load('getCommand_Bus_Middleware_SendMessageService'));
