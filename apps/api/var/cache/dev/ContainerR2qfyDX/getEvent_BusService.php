 ...
 */
class getEvent_BusService extends Owl_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['event.bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['event.bus.middleware.add_bus_name_stamp_middleware'] ??= new \Symfony\Component\Messenger\Middleware\AddBusNameStampMiddleware('event.bus'));
            ...
            yield 5 => ($container->privates['event.bus.middleware.send_message'] ?? $container->load('getEvent_Bus_Middleware_SendMessageService'));
