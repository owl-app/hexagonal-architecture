 ...
 */
class getDoctrine_MappingImportCommandService extends Owl_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 6).'/vendor/doctrine/doctrine-bundle/Command/ImportMappingDoctrineCommand.php';
