 ...
 */
class getQuery_BusService extends Owl_Apps_Api_ApiKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['query.bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['query.bus.middleware.add_bus_name_stamp_middleware'] ??= new \Symfony\Component\Messenger\Middleware\AddBusNameStampMiddleware('query.bus'));
            ...
            yield 5 => ($container->privates['query.bus.middleware.send_message'] ?? $container->load('getQuery_Bus_Middleware_SendMessageService'));
