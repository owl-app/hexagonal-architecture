...
class EntityManagerGhost4a7adfd extends \Doctrine\ORM\EntityManager implements \Symfony\Component\VarExporter\LazyObjectInterface
{
...
if (!\class_exists('EntityManagerGhost4a7adfd', false)) {
    \class_alias(__NAMESPACE__.'\\EntityManagerGhost4a7adfd', 'EntityManagerGhost4a7adfd', false);
}
